 ...
 *
 * `display_code` IS fillable, unlike Category::$code. The sheet has the user
 * type it and asks for a duplicate warning, so there is no autogenerated value
 * for a crafted POST to overwrite — the unique index is the guard instead.
 */
