            ...
            <form action="{{ route('masters.styles.update', $style) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="buyer_style_no" class="form-control" placeholder="e.g. BST-9942" value="{{ old('buyer_style_no', $style->buyer_style_no) }}">
                        <div class="form-text">Used on OC, Packing List &amp; Invoice</div>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Factory Style No.</label>
                        <input type="text" name="factory_style_no" class="form-control" placeholder="e.g. FST-3301" value="{{ old('factory_style_no', $style->factory_style_no) }}">
