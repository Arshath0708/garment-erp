            ...
            <table class="table table-sm table-bordered align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Colour / Size</th>
                        <th>Unit</th>
                        @canany(['cost-price.view', 'purchase-order.edit'])
                ...
                <tbody>
                    ...
                    @empty
                        <x-ui.empty-state :colspan="auth()->user()?->canAny(['cost-price.view', 'purchase-order.edit']) ? 9 : 8" icon="bi-box-seam" title="No items" />
                    @endforelse
                </tbody>
                @if($purchaseOrder->items->isNotEmpty())
                    <tfoot>
                        <tr class="fw-semibold table-light">
                            <td colspan="{{ auth()->user()?->canAny(['cost-price.view', 'purchase-order.edit']) ? 6 : 5 }}" class="text-end">Total</td>
